...
| Persona | Placeholder | Replace with (`cloud_model_id` in the persona config) |
|---|---|---|
| Oracle | `<openrouter-free-qwen-oracle>` | any verified-free Qwen long-context model from the catalog above |
| Jarvis | `<openrouter-free-qwen-coder>` | any verified-free Qwen-coding-tuned model from the catalog above |
| Paperclip | `<openrouter-free-llama>` | any verified-free Llama instruct model from the catalog above |
